...
public class PieChartView extends View {
     ...
     * 饼图半径
     */
    private float pieChartCircleRadius = 50;
     ...
     * 标记线长度
     */
    private float markerLineLength = 60f;
    ...
    protected void drawSector(Canvas canvas, int color, float startAngle, float sweepAngle) {
        ...
        paint2.setColor(Color.parseColor("#b2e5b2"));
        paint2.setStrokeWidth(5);//设置画笔宽度
        canvas.drawArc(pieChartCircleRectF, startAngle, sweepAngle, false, paint2);
