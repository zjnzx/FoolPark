...
public class RechargeDetailActivity extends BaseActivity implements ListViewPlus.ListViewPlusListener {
    ...
    ImageView ivEmpty;
    private Context context = RechargeDetailActivity.this;
    ...
    private void getDetail(int flag) {
        this.flag = flag;
//        String startDate = DateUtils.getTime(DateUtils.getLastDate(date));
