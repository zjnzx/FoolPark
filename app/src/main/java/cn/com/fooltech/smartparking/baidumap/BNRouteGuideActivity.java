 ...
 *
 */
public class BNRouteGuideActivity extends Activity {

    private final String TAG = BNRouteGuideActivity.class.getName();
...
//        BNDemoMainActivity.activityList.add(this);
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(MyApplication.ROUTE_PLAN_NODE);
